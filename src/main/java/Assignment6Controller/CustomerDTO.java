...
public class CustomerDTO {
    ...
    public static List<BankCustomer> searchCustomers(String lastName, String firstName, String email, String phone, String city) { // For use in CustomerSearch.java
        List<BankCustomer> searchResults = null;

        try {
            // Call the method in CustomerDAO.java to perform the search
            searchResults = cd.search(lastName, firstName, email, phone, city);
