...
public class CustomerSearch extends javax.swing.JFrame {
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addComponent(jLabel6)) // Add the new JLabel for city
                                                .addGap(18, 18, 18)
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addComponent(city, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE))))) // Add the city JTextField
                        .addGroup(layout.createSequentialGroup()
                                .addGap(150, 150, 150)
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        List<BankCustomer> searchResults = CustomerDTO.searchCustomers(lastName, firstName, email, phone, city);

        // Check if any results were found
        if (searchResults != null && !searchResults.isEmpty()) {

            // Convert the list of BankCustomer objects to an array of strings for the JList
            String[] customerNames = searchResults.stream()
                    .map(customer -> customer.getFirstName() + " " + customer.getLastName())
                    .toArray(String[]::new);

            // Show the CustomerList form
            CustomerList customerListForm = new CustomerList();
            customerListForm.setCustomerList(searchResults); // Pass the search results to the method
            customerListForm.setVisible(true);

        } else {
            // If no results were found, display a message to the user
            JOptionPane.showMessageDialog(this, "No customers found matching the search criteria.");
        }
    }
